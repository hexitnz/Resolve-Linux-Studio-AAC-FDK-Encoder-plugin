...
private:
    ...
    // AudioSpecificConfig blob from aacEncInfo(), forwarded to the muxer via
    // pIOPropMagicCookie on every output buffer so it can write a correct
    // esds box instead of guessing sample rate / object type.
